...
use crate::ir::ast::{Component, ComponentReference, Equation, Expression};
...
pub struct Dae {
    ...
    pub fr: IndexMap<String, (ComponentReference, Expression)>, // reset expressions, condition -> (component, expression)
}
