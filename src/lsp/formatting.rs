...
pub fn handle_formatting(
    ...
    let formatted = format_modelica_code(text, options);
...
fn format_modelica_code(text: &str, options: &FormattingOptions) -> String {
...
mod tests {
    ...
    fn test_format_simple_model() {
        ...
        let result = format_modelica_code(input, &default_options());
