...
⚠️ **These templates are NOT installed with Rumoca** - They exist in the source repository as educational examples only.
...
- ⚡ **Fast** - No template rendering overhead
- 🔒 **Type-safe** - Compile-time validation
- 🧹 **Maintainable** - Schema changes only need Rust updates
- ✅ **Standards-compliant** - MCP-0031 Base Modelica IR
...
The Base Modelica JSON → Cyecca workflow solves these issues with:
